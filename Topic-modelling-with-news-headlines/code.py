...
plt.bar(x=top_20_words,height=top_20_values)
...
# --------------
# coherence score
coherence_model_lda = CoherenceModel(model=lda_model,texts=clean_headlines,dictionary=dictionary,
coherence='c_v')
...
def compute_coherence_values(dictionary, corpus, texts, limit, start=2, step=3):
    ...
    for num_topics in range(start,limit,step):
        model = LdaModel(doc_term_matrix,num_topics=num_topics,random_state=2,id2word=dictionary,
        iterations=10)
